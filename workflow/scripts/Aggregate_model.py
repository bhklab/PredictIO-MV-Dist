# -----------------------------------------------------------
# XGBoost Model Aggregation Script
# This script merges multiple local XGBoost models (JSON format)
# into a single global model using tree-level bagging.
#
#   - Loads individual local model files
#   - Merges their decision trees into one global model
#   - Saves the global model in both JSON and binary (.model) formats
#   - Extracts and prints summary model parameters
# -----------------------------------------------------------
...
# Aggregates multiple XGBoost models into one global model (tree merging).
